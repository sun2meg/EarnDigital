...
public class RedeemPayTm extends AppCompatActivity {
    ...
    private String email,name,bank,number;
...
//                    String userId = user1.getEmail();
                    ...
                    mRefStatus.child("Name").setValue(name);
                    mRefStatus.child("Bank").setValue(bank);
                    mRefStatus.child("Acct Number").setValue(number);
